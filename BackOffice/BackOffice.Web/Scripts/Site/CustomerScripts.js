...
/*Customer Calification Project Config*/
var Customer_CalificationProjectObject = {
    ObjectId: '',
    CustomerPublicId: '',
    ...
    RenderAsync: function () {
        ...
        Customer_CalificationProjectObject.ConfigEvents();
    },
    ...
    ConfigKeyBoard: function () {
        ...
        $(document.body).keydown(function (e) {
            if (e.altKey && e.shiftKey && e.keyCode == 71) {
                ...
                //save
                $('#' + Customer_CalificationProjectObject.ObjectId).data("kendoGrid").saveChanges();
            }
            else if (e.altKey && e.shiftKey && e.keyCode == 78) {
                //alt+shift+n

                //new field
                $('#' + Customer_CalificationProjectObject.ObjectId).data("kendoGrid").addRow();
            }
            else if (e.altKey && e.shiftKey && e.keyCode == 68) {
                //alt+shift+d

                //new field
                $('#' + Customer_CalificationProjectObject.ObjectId).data("kendoGrid").cancelChanges();
            }
        });
    },
    ...
    ConfigEvents: function () {
        //config grid visible enables event
        $('#' + Customer_CalificationProjectObject.ObjectId + '_ViewEnable').change(function () {
    ...
    CalificationProjectConfig: function () {
        $('#' + Customer_CalificationProjectObject.ObjectId).kendoGrid({
            ...
            dataSource: {
                ...
                schema: {
                    ...
                    model: {
                        id: "CalificationProjectConfigId",
                        fields: {
