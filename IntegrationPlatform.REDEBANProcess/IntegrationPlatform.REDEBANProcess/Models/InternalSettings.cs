...
namespace IntegrationPlatform.REDEBANProcess.Models
{
    public class InternalSettings : System.Collections.DictionaryBase
    {
        ...
        public int Count
        {
            get
            {
                return SettingsManager.SettingsController.SettingsInstance.ModulesParams[IntegrationPlatform.REDEBANProcess.Models.Constants.C_SettingsModuleName].Count;
            }
        }
    }
}
