...
{
    internal class Survey_MySqlDao : Interfaces.ISurveyData
    {
        ...
        public ProveedoresOnLine.SurveyModule.Models.SurveyModel SurveyGetByUser(string ParentSurveyPublicId, string User)
        {
        ...
        public List<SurveyModel> BPSurveyGetReminders()
        {
            ADO.Models.ADOModelResponse response = DataInstance.ExecuteQuery(new ADO.Models.ADOModelRequest()
            {
                CommandExecutionType = ADO.Models.enumCommandExecutionType.DataSet,
                CommandText = "BP_MP_Survey_GetReminders",
                CommandType = System.Data.CommandType.StoredProcedure,
                Parameters = null
            });
        ...
        public List<ProveedoresOnLine.Company.Models.Util.GenericChartsModelInfo> GetSurveyByName(string CustomerPublicId, string ResponsableEmail)
        {
            ...
            {
                CommandExecutionType = ADO.Models.enumCommandExecutionType.DataTable,
                CommandText = "MP_CP_SurveyCharts_GetByName",
                CommandType = System.Data.CommandType.StoredProcedure,
                Parameters = lstParams
            });
        ...
        public List<ProveedoresOnLine.Company.Models.Util.GenericChartsModelInfo> GetSurveyByMonth(string CustomerPublicId, string ResponsableEmail)
        {
            ...
            {
                CommandExecutionType = ADO.Models.enumCommandExecutionType.DataTable,
                CommandText = "MP_CP_SurveyCharts_GetByMonth",
                CommandType = System.Data.CommandType.StoredProcedure,
                Parameters = lstParams
            });
        ...
        public List<SurveyModel> ReportAllSurvey(string SurveyPublicId, string CustomerPublicId)
        {
            ...
            {
                CommandExecutionType = ADO.Models.enumCommandExecutionType.DataSet,
                CommandText = "MP_CP_ReportAllSurveyByCustomer",
                CommandType = CommandType.StoredProcedure,
                Parameters = lstParams,
            });
