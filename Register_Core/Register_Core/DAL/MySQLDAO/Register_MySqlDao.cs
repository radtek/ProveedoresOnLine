...
namespace Register_Core.DAL.MySQLDAO
{
    internal class Register_MySqlDao : IRegisterData
    {
        private ADO.Interfaces.IADO DataInstance;

        public Register_MySqlDao()
        {
            DataInstance = new ADO.MYSQL.MySqlImplement(Models.Constants.C_POL_IntegrationPlatformConnectionName);
        }
