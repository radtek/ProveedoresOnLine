...
namespace MarketPlace.Web.Areas.Desktop.Controllers
{
    public partial class ProviderController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult GICalificationProjectDetail()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.GICalificationProjectDetail);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult RPDIAN()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.RPDIAN);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult CDCustomData()
        {
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string GICalificationProjectDetail = "GICalificationProjectDetail";
        ...
        public class ActionNameConstants
        {
            ...
            public const string GICalificationProjectDetail = "GICalificationProjectDetail";
        ...
        static readonly ActionParamsClass_GICalificationProjectDetail s_params_GICalificationProjectDetail = new ActionParamsClass_GICalificationProjectDetail();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_GICalificationProjectDetail GICalificationProjectDetailParams { get { return s_params_GICalificationProjectDetail; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_GICalificationProjectDetail
        {
            public readonly string ProviderPublicId = "ProviderPublicId";
        }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_RPDIAN RPDIANParams { get { return s_params_RPDIAN; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_RPDIAN
        {
            public readonly string SearchParam = "SearchParam";
            public readonly string SearchFilter = "SearchFilter";
        }
        static readonly ActionParamsClass_CDCustomData s_params_CDCustomData = new ActionParamsClass_CDCustomData();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_CDCustomData CDCustomDataParams { get { return s_params_CDCustomData; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        public class ViewsClass
        {
            ...
            public readonly string CDCustomData = "~/Areas/Desktop/Views/Provider/CDCustomData.cshtml";
            ...
            public readonly string GICalificationProjectDetail = "~/Areas/Desktop/Views/Provider/GICalificationProjectDetail.cshtml";
            ...
            public readonly string RPGerencial = "~/Areas/Desktop/Views/Provider/RPGerencial.cshtml";
            ...
            public readonly string SVSurveyEvaluatorDetail = "~/Areas/Desktop/Views/Provider/SVSurveyEvaluatorDetail.cshtml";
            public readonly string SVSurveyProgram = "~/Areas/Desktop/Views/Provider/SVSurveyProgram.cshtml";
            public readonly string SVSurveyReport = "~/Areas/Desktop/Views/Provider/SVSurveyReport.cshtml";
    ...
    public partial class T4MVC_ProviderController : MarketPlace.Web.Areas.Desktop.Controllers.ProviderController
    {
        ...
        [NonAction]
        partial void GICalificationProjectDetailOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string ProviderPublicId);

        [NonAction]
        public override System.Web.Mvc.ActionResult GICalificationProjectDetail(string ProviderPublicId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.GICalificationProjectDetail);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "ProviderPublicId", ProviderPublicId);
            GICalificationProjectDetailOverride(callInfo, ProviderPublicId);
            return callInfo;
        }
        ...
        [NonAction]
        partial void RPDIANOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string SearchParam, string SearchFilter);

        [NonAction]
        public override System.Web.Mvc.ActionResult RPDIAN(string SearchParam, string SearchFilter)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.RPDIAN);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "SearchParam", SearchParam);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "SearchFilter", SearchFilter);
            RPDIANOverride(callInfo, SearchParam, SearchFilter);
            return callInfo;
        }

        [NonAction]
        partial void CDCustomDataOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string ProviderPublicId);

        [NonAction]
        public override System.Web.Mvc.ActionResult CDCustomData(string ProviderPublicId)
        {
