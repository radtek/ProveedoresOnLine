    ...
    public partial class SurveyController : BaseController
    {
            ...
            string PageNumber)
        {
                ...
                !string.IsNullOrEmpty(SessionModel.CurrentCompany.CompanyPublicId))
            {
                ...
                oModel.ElasticCompanySurveyModel = client.Search<CompanySurveyIndexModel>(s => s
                ...
                .Query(q => q.
                    ...
                    .Filter(f2 =>
                    {
                        ...
                        //        .Query(fq => fq
                        //            .Match(match => match
                        //            .Field(field => field.oSurveyIndexModel.First().SurveyStatusId)
                        ...
                        //        .Query(fq => fq
                        //            .Match(match => match
                        //            .Field(field => field.oSurveyIndexModel.First().SurveyTypeId)
