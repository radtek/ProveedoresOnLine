...
namespace MarketPlace.Web.Controllers
{
    ...
    public partial class BaseController : Controller
    {
        ...
        public List<GenericMenu> GetHeaderMenu()
        {
            ...
            if (oCurrentUserModules.Any(x => x == (int)enumModule.ProviderInfo))
            {
            ...
            if (oCurrentUserModules.Any(x => x == (int)enumModule.SelectionInfo))
            {
            ...
            if (oCurrentUserModules.Any(x => x == (int)enumModule.StatisticsInfo))
            {
            ...
            if (oCurrentUserModules.Any(x => x == (int)enumModule.ThirdKnowledgeInfo))
            {
            ...
            if (oCurrentUserModules.Any(x => x == (int)enumModule.ReportsInfo))
            {
                //Modulo de Reportes
                oReturn.Add(new GenericMenu()
                {
